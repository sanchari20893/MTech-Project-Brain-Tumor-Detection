...
Original file is located at
    https://colab.research.google.com/drive/1IGWk0Vp_2s8hzSBVcV2hHCrygbhP4OkY
"""
...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + dataset
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("braintumor", 1, "glioblastoma")
        self.add_class("braintumor", 2, "meningioma")
        self.add_class("braintumor", 3, "healthy")
        ...
        for a in annotations:
            ...
            objects = [s['region_attributes']['dataset'] for s in a['regions']]
            print("dataset:",objects)
            name_dict = {"glioblastoma": 1,"meningioma": 2,"healthy": 3}
            # key = tuple(name_dict)
            ...
            self.add_image(
                "braintumor",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "braintumor":
            return super(self.__class__, self).load_mask(image_id)

        # Convert polygons to a bitmap mask of shape
        # [height, width, instance_count]
        info = self.image_info[image_id]
        if info["source"] != "braintumor":
            return super(self.__class__, self).load_mask(image_id)
